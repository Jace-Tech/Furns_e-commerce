...
require_once("../../assets/handlers/utils/index.php");
...
if(isset($_POST["submit"])):
    ...
    if($result->rowCount() > 0):
        ...
        header("location: ../index.php?alert=ue_f");
    endif;
endif;
...
if(isset($_POST["token"])):
    ...
    if(isset($_COOKIE["FORGOT_ID"])):
        ...
        header("location: ../index.php?alert=cookie_e");
    endif;
endif;
...
if(isset($_POST["change"])):
    ...
    if (isset($_COOKIE["FORGOT_ID"])) :
        ...
        if($result) : 
            ...
            header("location: ../index.php?alert=pc_s");
        endif;
