<?php include("./handlers/config/index.php"); ?>
<?php include("./handlers/session.php"); ?>
...
<head>
    ...
    <title style="text-transform: capitalize;"> <?php if (isset($page)) echo $page; ?> | Notika - Notika Admin Template</title>
    ...
    <!-- BOOTSTRAP CSS -->
    <link rel="stylesheet" href="./css/boots/bootstrap-grid.min.css">
    <link rel="stylesheet" href="./css/boots/bootstrap-utilities.min.css">
</head>
                    ...
                    <div class="header-top-menu">
                        <ul class="nav navbar-nav notika-top-nav">
                            ...
                            <li class="nav-item ml-3">
                                <a href="#" id="logoutBtn" title="logout" role="button" aria-expanded="false" class="nav-link dropdown-toggle d-flex align-items-center">
                                    <span><i class="notika-icon notika-back text-danger"></i></span>
                                </a>
                            </li>
                        </ul>
                    </div>
