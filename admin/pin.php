    ...
    <div class="nk-block toggled">
      <form method="POST" action="./handlers/forgot_password.php" class="nk-form">
        <div class="input-group">
          ...
          <div class="nk-int-st">
            <input required type="text" name="pin" class="form-control" placeholder="Pin">
          </div>
        </div>

        <button type="submit" name="token" class="btn btn-login btn-success btn-float"><i class="notika-icon notika-right-arrow"></i></button>
      </form>
